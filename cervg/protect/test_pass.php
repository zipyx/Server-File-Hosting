...
$hasheduser  = file_get_contents("protect/user.txt"); // this is our stored user
$hashedpass  = file_get_contents("protect/pass.txt"); // and our stored password
...
if ((password_verify($user, $hasheduser)) && (password_verify($pass,$hashedpass))) {
    ...
    ?>
    <form method="POST" action="http://fam.cervg.com">
    User <input font-size: 40px  type="text" name="user"></input><br/>
